...
import os
from prepare_model import clean_state_dict_keys
...
PATH_TO_EFFICIENTNET_WEIGHTS = '/home/ivanam/Seminar1/pretraining/ssl_checkpoints/efficientnet_b0_embryo_sslbs128_best.pth'
NUM_CLASSES = 2 
...
# Ovo resetuje klasifikacioni sloj na NUM_CLASSES (2)
model.classifier[1] = nn.Linear(in_features, NUM_CLASSES) 

print(f"Klasifikacioni sloj je modifikovan na {NUM_CLASSES} izlaznih klasa.")
...
LEARNING_RATE = 3e-4  # Povećajte ga na 3e-4
WEIGHT_DECAY = 1e-4   # Dodajte weight decay za AdamW
MOMENTUM = 0.9        # Momentum je nebitan ako koristimo AdamW

criterion = nn.CrossEntropyLoss()
optimizer = optim.AdamW(model.parameters(), lr=LEARNING_RATE, weight_decay=WEIGHT_DECAY)

scheduler = lr_scheduler.StepLR(optimizer, step_size=4, gamma=0.1)
# Svakih 7 epoha, LR se množi sa 0.1
...
SAVE_PATH = f'training/finetuned_models/eNet/{MODEL_NAME}_best_model.pth' 
# --------------------------------------------------
...
LOG_FILE_PATH = f'training/efficientNet/results/{MODEL_NAME}_training_log.csv'
