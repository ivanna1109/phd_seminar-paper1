...
from pretraining.projection_head import ProjectionHeadBarlow as ProjectionHead
...
# --- Hiperparametri ---
MODEL_NAME = 'mobilenet_v3_large' # sad MobileNetV3Large
