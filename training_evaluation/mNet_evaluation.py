...
MODEL_NAME = 'mobilenet_v3_large_ssl_finetuned'
NUM_CLASSES = 2
BATCH_SIZE = 32 
SAVE_WEIGHTS_PATH = f'/home/ivanam/Seminar1/training/finetuned_models/mNet/{MODEL_NAME}_new_without_CW_best_model.pth' 
...
OUTPUT_FILE_PATH = os.path.join(OUTPUT_DIR, f'{MODEL_NAME}_without_CW_evaluation_results.txt')
